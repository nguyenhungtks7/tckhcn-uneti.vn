...
<div class="body_getdata" style="display: flex; margin-top: 50px; margin-right: 32px; margin-bottom: 75px">
    ...
    <div style="width: 62%; margin: 0; padding: 4px; box-sizing: border-box">
        ...
        <div style="align-items: flex-end; font-family: 'Times New Roman'; font-size: 1vw;font-style: italic; margin-bottom: 20px;">
        ...
        <div>
        <h style="font-size: 1.2vw;"> DANH MỤC BÀI VIẾT</h>
            <table class="table tab-content">
                ...
                foreach ($result_file as $file):
                    ...
                    ?>
                    <tr>
                        <td style="font-weight: normal; font-size: 1.2vw;">
                            <?php echo $counter; ?>.
                        </td>
                        <td class="font-weight-bold f-left">
                            <a style="color: #1a3f5e; text-transform:uppercase; font-size: 1vw;" href="<?= url('chi-tiet/bai-dang/' . $id) ?>">
                                <?php
