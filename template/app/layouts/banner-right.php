...
<div class="img_lienket" style = "width: 15%; text-align: center; margin-top: 2vh;" >
    ...
    <div class="author-guide">
        ...
        <a href="./public/upload/The_le_tap_chi.pdf" class="guide-link">Hướng dẫn gửi bài</a>
        <a href="<?= url("lienhe") ?>" class="guide-link">Liên hệ tạp chí</a>
        <a href="./public/upload/The_le_tap_chi.pdf" class="guide-link">Mẫu quy cách bài viết</a>
        <a href="./public/upload/dao_duc_khi_xuat_ban.pdf" class="guide-link" style="">Đạo đức khi xuất bản</a>
